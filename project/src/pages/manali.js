...
function Manali() {
  ...
  useEffect(()=>
  {
    axios.get("http://localhost:5050/getmanali").then((response)=>
    {
...
<div className="wild" >
  ...
  <div className="container" style={{marginLeft:150}}>
      <h1>
       Explore Manali<span style={{color:"#ff6612",fontfamily:"SFProDisplay-Bold"}}> Tour Packages</span>
      </h1>
